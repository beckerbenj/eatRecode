...
new_recodes2 <- data.frame(oldValues = c("Italia", "Wales", "Ingland", "Bavaria", "Italia", "Italia", "Wales"),
                           newValues = c("Italy", "Wales", "England", "Austria", "Italy", "Italy", "Wales"), stringsAsFactors = FALSE)
...
test_that("updating a recode list", {
  ...
  updateRecodeDB(new_recodes2, recodeDBPath = "helper_recodeDB.xlsx", newRecodeDBPath = f, name = "country")
